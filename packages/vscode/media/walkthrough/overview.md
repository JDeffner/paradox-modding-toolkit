...
- **Create** lists the visual creators the active game has: Trait, Dynasty Legacy, Culture, Dynasty Tree and New Coat of Arms. Each one is a form over the game's own keys, and it writes the definition and its localization into your mod.
