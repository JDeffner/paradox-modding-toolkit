...
Use **Setup & Health Check** in **Project**, or click **PX Toolkit** in the status bar to run this check again. Its tooltip also shows both sources. Open **Output > Paradox Modding Toolkit** for the full report and the dump folder in use.
